...
@app.route('/earnings/daydate', methods=['GET', ])
def _earnings_daydate():
...
@app.route('/earnings/daydate/<int:_id>&<dates>&<datee>', methods=['GET'])
def _earnings_daydate_(_id,dates,datee):
    store_id = c.session['store']
    cnt_days = {}
    cnt_days['상품목록'] = {}
    cnt_days['상품분류'] = {}
...
@app.route('/earnings/daydate1', methods=['GET', ])
def _earnings_daydate1():
    store_id = c.session['store']
    if c.is_GET():
...
@app.route('/earnings/daydate2', methods=['GET', ])
def _earnings_daydate2():
    store_id = c.session['store']
    if c.is_GET():
...
@app.route('/earnings/daydate3', methods=['GET', ])
def _earnings_daydate3():
    store_id = c.session['store']
    if c.is_GET():
...
@app.route('/earnings/daydate4', methods=['GET', ])
def _earnings_daydate4():
    store_id = c.session['store']
    if c.is_GET():
...
@app.route('/earnings/daydate5', methods=['GET', ])
def _earnings_daydate5():
    store_id = c.session['store']
    if c.is_GET():
...
@app.route('/earnings/daydate6', methods=['GET', ])
def _earnings_daydate6():
    store_id = c.session['store']
    if c.is_GET():
